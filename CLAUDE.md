...
git -C ~/repos/mindroot-v2 pull origin main
git -C ~/repos/atom-agent pull origin main
...
| # | Arquivo | Path |
|---|---------|------|
| 1 | Genesis v5 | `atom-engine-core/law/system_spec_genesis_v5-0-2.md` |
| 2 | Marco Zero v2 | `atom-engine-core/law/system_spec_marco-zero_v2-0.md` |
| 3 | Meta-Template v1.1 | `atom-engine-core/law/system_template_meta-template_v1-1.md` |
| 4 | PENTAGON.md | `atom-engine-core/PENTAGON.md` |
| 5 | Build Protocol | `atom-engine-core/specs/system_spec_genesis-build-protocol_v1-0.md` |

**Regra:** só operar depois de ler os 5. Sem exceção. Sem atalho.
